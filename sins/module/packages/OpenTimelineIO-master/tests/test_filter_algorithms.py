...
"""Test harness for the each_filter algorithms."""
...
class FilterTest(unittest.TestCase, otio.test_utils.OTIOAssertions):
    ...
    def test_copy_stack(self):
        """Test a no op each_filter that copies the timeline."""
    ...
    def test_prune_clips_starting_with_a(self):
        """test a each_filter that removes things whose name starts with 'a'"""
    ...
    def test_prune_clips(self):
        """test a each_filter that removes clips"""
