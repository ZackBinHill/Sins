...
:py:class:`Model` classes, :py:class:`InField` instances and model instances all
...
InField instance    Column on a table
...
The :py:class:`InField` class is used to describe the mapping of
...
=====================   =================   =================   =================
InField Type              Sqlite              Postgresql          MySQL
=====================   =================   =================   =================
...
InField initialization arguments
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
+--------------------------------+------------------------------------------------+
| InField type                     | Special Parameters                             |
+================================+================================================+
...
:py:attr:`InField.field_type` attribute.
